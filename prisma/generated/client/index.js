...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\nkari\\Documents\\moondex\\moondex.v1\\prisma\\generated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\nkari\\Documents\\moondex\\moondex.v1\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "mysql://root:@localhost:3306/moondex",
        "value": null
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/client\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"mysql://root:@localhost:3306/moondex\")\n}\n\nmodel User {\n  id        String   @id @default(cuid())\n  name      String?\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "7e88f0c4d5c1a209babfa0fb02d0034bf0242b5c79cd2e83d880f60350f84286",
  "copyEngine": true
}
